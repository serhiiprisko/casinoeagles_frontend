  ...
  <div class="main-container bg-primary" :class="($mq==='xl' || $mq==='lg') ? 'desktop' : 'mobile'">
    <b-container class="py-4">
      ...
      <b-form class="px-3" @keyup.enter="registerAction">
          ...
          <b-col>
            <b-form-row>
              ...
              <b-col cols="12">
                ...
                <b-form-invalid-feedback :state="!isDuplicatedEmail">
                  {{ 'Email already exist!' }}
                </b-form-invalid-feedback>
              </b-col>
              <b-col cols="12">
        ...
        <b-row class="my-2" v-show="isDisplayIP">
          <b-col cols="12">
            <b-form-invalid-feedback :state="!isDuplicatedIp" v-bind:style="{ fontSize: '20px' }">
              {{ $t('account_exist_with_ip') }}
              <b-link @click="loginAction()" class="text-secondary" style="text-decoration-line: underline; font-size:20px;">
                {{ $t('clck_buton') }}
              </b-link>
            </b-form-invalid-feedback>
          </b-col>
              ...
              <b-form-group>
                ...
                <b-col cols="12" class="mt-2">
                  <div class="text-white">
                    <b-img :src="`/green-arrow.png`" class="px-2 py-1" height="40" />
                    {{ $t('promo_description_text') }}
                  </div>
                </b-col>
              </b-form-group>
            </b-collapse>
        ...
        try {
          ...
          if (data.status === 0) {
            ...
            if (data.message === 'EMAILEXIST') {
              ...
              this.isDuplicatedIp = false
              this.isDisplayIP = 0
            } else if (data.message === 'IPEXIST') {
              this.isDuplicatedIp = true
              this.isDisplayIP = 1
